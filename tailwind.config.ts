  ...
  theme: {
    ...
    extend: {
      ...
      animation: {
        ...
        "wave-flow-extra": "wave-flow 17s linear infinite",
        "wave-flow-reverse-extra": "wave-flow-reverse 21s linear infinite",
        "wave-flow-ultra": "wave-flow 26s linear infinite",
        "wave-flow-mega": "wave-flow-reverse 19s linear infinite",
        "wave-flow-hyper": "wave-flow 14s linear infinite",
        "wave-flow-reverse-hyper": "wave-flow-reverse 28s linear infinite",
        "wave-flow-purple-yellow-1": "wave-flow 16s linear infinite",
        "wave-flow-purple-yellow-2": "wave-flow-reverse 24s linear infinite",
        "wave-flow-purple-yellow-3": "wave-flow 19s linear infinite",
        "wave-flow-purple-yellow-4": "wave-flow-reverse 27s linear infinite",
        "wave-flow-purple-yellow-5": "wave-flow 21s linear infinite",
      },
    },
  },
